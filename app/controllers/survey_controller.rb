class SurveyController < ApplicationController
  ...
  private
    ...
    def self_esteem_params
      params.require(:self_esteem).permit(:personal_datum_id, :alcohol, :tabacco, :drugs, :walking_time_per_day, :jogging_time_per_day, :gym_workout_time_per_day, :swimming_time_per_day, :wholesome_food_per_day, :junk_food_per_day, :weather, :season, :self_esteem)
    end
end
